...
//    }
    ...
    public void findPwd(@PathVariable("email") String email) {
        ...
        String body = "<a href=\"http://localhost:5173/find/pwd/result\"><img src=\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSz-CCkIhl1viV7TNN9ZF0KHs465GQeebZ-8Ukb6PVCrg&s\" alt=\"로고\"></a>\n"; // 이메일 본문

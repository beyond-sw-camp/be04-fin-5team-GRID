...
<template>
  <div class="registAll">
    <div class="registHeader">
      <div><h1 class="fw-bolder"><i class="bi bi-pencil-square"></i>&nbsp; 결재 작성</h1></div>
    </div>
    ...
    <div class="row py-5 row-cols-1 row-cols-lg-4">
      ...
      <div class="feature col">
        <b-card class="mx-1">
          ...
          <h3 >단축 근무</h3>
          <p>단축 근무 신청 결재는 임신중인 직원만 제출 가능하며, 승인 시 신청 기간동안 1일 2시간씩 근무 시간이 단축됩니다. 원활한 승인 절차를 위해 결재 제출 시 증명 서류 첨부가 필요합니다.</p>

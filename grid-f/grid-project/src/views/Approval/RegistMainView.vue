...
<template>
  <div class="registAll">
    <div class="registHeader">
      <div>
        <h1 class="fw-bolder"><i class="bi bi-pencil-square"></i>&nbsp; 결재 작성</h1>
      </div>
    </div>
      ...
      <div class="container py-3 mx-0 px-0" id="featured-3">
        <div class="row py-5 row-cols-1 row-cols-lg-4">
          <div class="feature col">
            <b-card class="mx-1" style="height: 300px">
              <div
          ...
          <div class="feature col">
            <b-card class="mx-1" style="height: 300px">
              ...
              <h3>시간 외 근무</h3>
              <p>시간 외 근무는 평일 오후 7시부터 익일 오전 6시까지, 주말 모든 시간 가능합니다. 주별 시간 외 근무 합계는 12시간을 넘을 수 없으며, 이를 준수하지 않을 경우 결재 제출이
                불가하니 유의하시기 바랍니다.</p>
              <br>
              <button class="btn btn-primary btn-sm btn-custom-1"
                @click="navigateTO('overtime')"><span>작성하기</span></button>
          ...
          <div class="feature col">
            <b-card class="mx-1" style="height: 300px">
              ...
              <h3>단축 근무</h3>
              <p>단축 근무 신청 결재는 임신 중인 직원만 제출 가능하며, 승인 시 신청 기간동안 1일 2시간씩 근무 시간이 단축됩니다. 원활한 승인 절차를 위해 결재 제출 시 증명 서류 첨부가
                필요합니다.</p>
              <br><br>
          ...
          <div class="feature col">
            <b-card class="mx-1" style="height: 300px">
              ...
              <h3>휴가</h3>
              <p>휴가 결재를 작성할 때, 여러 종류의 휴가를 동시에 사용하려면 각각 별도의 결재를 작성해야 합니다. 정기 휴가, 연차, 월차는 자신이 보유한 휴가 일수를 초과하여 사용할 수 없습니다.
              </p>
              <br><br>
                <button class="btn btn-primary btn-sm btn-custom-1"
                  @click="navigateTO('vacation')"><span>작성하기</span></button>
            </b-card>
          </div>
        </div>
      </div>

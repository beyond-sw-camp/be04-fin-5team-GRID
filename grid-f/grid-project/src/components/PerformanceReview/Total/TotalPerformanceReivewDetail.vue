...
const fetchReviewDetail = async () => {
  try {
    ...
    // 종합평가 먼저 조회해서 넣기
    const responseTotalReview = await axios.get(`https://api.gridhr.site/total-performance-review/${id}`)
    ...
    const responseMid = await axios.get(`https://api.gridhr.site/performance-review/detail/${midtermId}`);
    ...
    const responseFin = await axios.get(`https://api.gridhr.site/performance-review/detail/${finalId}`);

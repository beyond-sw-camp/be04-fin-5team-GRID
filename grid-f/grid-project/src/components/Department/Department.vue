...
const fetchLeaderName = async (leaderId) => {
  try {
    const response = await axios.get(`https://api.gridhr.site/users/id/${leaderId}`);
...
const addNewDepartment = async () => {
  ...
  try {
    await axios.post('https://api.gridhr.site/department', newDepartment.value);
    await fetchDepartments();
...
const modifyDepartmentsStatus = async () => {
  ...
  try {
    const response = await axios.put('https://api.gridhr.site/department/status', selectedDepartments.value);
...
const updateLeader = async () => {
  ...
  try {
    const response = await axios.put('https://api.gridhr.site/department/department-leader', {

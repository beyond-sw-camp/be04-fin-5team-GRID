...
| 박고은 |  결재 기능을 맡아 복잡한 로직을 구현하고 예외 처리를 고민하면서 다양한 방법을 탐색할 수 있던 좋은 기회였습니다. 코드의 일관성과 가독성을 높이기 위해 팀원들과 함께 응답 객체 형식, 함수명 등의 코딩 스타일을 맞추어 개발했습니다.
기획 단계에서 새로운 기능이 추가되는 변경 사항이 있었고, 이로 인해 일정에 영향을 받는 부분이 가장 어려웠습니다. 그러나 회의를 통해 추가된 부분을 포함하여 작업 파트를 재분배하고 우선순위를 설정하여, 낮은 우선순위의 기능은 추후 개발 항목으로 변경하는 방향으로 해결했습니다.
개발 과정에서 많은 것을 배울 수 있었고, 팀원들과 협동하여 우수 프로젝트를 수상하는 좋은 결과를 얻어 더욱 뿌듯한 경험이었습니다.|
